...
#define POINT_NAME                      "Point name"
#define POINT_UDP_PORT                  49750
#define STATION_NAME                    "Your station name"
//#define REMOTE_UDP_ADDRESS              "192.168.1.9"
//#define REMOTE_UDP_PORT                 49750
#define WIFI_STATION_NAME               "Your hotspot name"
#define WIFI_STATION_PASS               "Hotspot pass"
...
*/
    ...
    if(!UDPwifi.begin(POINT_UDP_PORT)) {
...
int connectClient() {
    ...
    if (0 > stationIndex(WIFI_STATION_NAME)) {
        Serial.printf("Failure! Couldn't find the WIFI station specified --- \"%s\"\n"
                        , WIFI_STATION_NAME);
        return 0; 
    }

    // Connect to the station    
    WiFi.begin(WIFI_STATION_NAME, WIFI_STATION_PASS);
    ...
    if (cd != WL_CONNECTED) {   
        Serial.printf("Failure! Couldn't connect to the WIFI station --- \"%s\"\n"
                        , WIFI_STATION_NAME);
        return 0;                        
    }
...
void msgSetupOk() {
    ...
    Serial.print(":");
    Serial.print(POINT_UDP_PORT);    
    Serial.print(") connected to the WIFI station \"");    
    Serial.print(WIFI_STATION_NAME);
    Serial.print("\"");    
    Serial.print("\n\n\n");
