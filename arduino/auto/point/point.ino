...
#define POINT_NAME                      "Your point name"       // the board name of the link
#define STATION_NAME                    "Your station name"         // the name of the supervisor station
#define UDP_PORT                        49750           // the predifined UDP port of the link
#define WIFI_HOTSPOT_NAME               "Your hotspot name"     // the WiFi hotspot name
#define WIFI_HOTSPOT_PASS               "Hotspot pass"    // the WiFi hotspot password
